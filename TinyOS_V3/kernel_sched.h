...
typedef struct thread_control_block
{
  ...
  int priority;		/**< An integer that corresponds to the position of the thread in the priority queue */
  int pbackup;
  
  unsigned long curtimemicro; /**< The time where the thread inserted the queue */
...
/** 
   ...
   */
void sleep_releasing(Thread_state newstate, Mutex* mx, Yield_Reason);

int Cond_Wait_Flag(Mutex*,CondVar*, Yield_Reason);
...
/** @} */
#define MAX_PRIORITY_QUEUES (10)
#define QUANTUMS_FREEZED (20)
#endif
