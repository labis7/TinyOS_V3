 ...
 *******************************************/
#ifndef YIELD_REASONS
#define YIELD_REASONS
typedef enum {
	QR, /**< Quantum Reached */
	IO, /**< IO */
	ML, /**< Mutex Lock */
 ...
 */
#define MUTEX_INIT 0
//#define BETTER_MUTEX_INIT {MUTEX_INIT, NULL}
//#define MAXIMUM_BETTER_MUTEXES (128)
...
//void Better_Mutex_Lock(Mutex*, TCB*);
...
//void Better_Mutex_Unlock(Mutex*, TCB*);
